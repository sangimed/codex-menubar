...
<p align="center">
  ...
  <br />
  <sub>Example with the percentage display set to <strong>Remaining</strong>, showing the 5-hour window, weekly quota, and credits directly in the menu bar.</sub>
</p>
